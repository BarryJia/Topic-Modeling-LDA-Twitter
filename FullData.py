...
def getContent(fileBefore):
    ...
    with open('api_keys_another.json') as f:
        keys = json.load(f)
    ...
    tmp=[]
    csvFile = open(fileBefore + '_full.csv', 'w', encoding='utf-8', newline='')
    csvWriter = csv.writer(csvFile)
    for go in range(i):
        try:
            print('currently getting {} - {}'.format(start, end)+'   total: {}'.format(limit))
...
if __name__=="__main__":
    #for num in range(9,29):
     #   if (num < 10):
      #      getContent("data/after/020" + str(num))
       #     sleep(60)
        #else:
         #   getContent("data/after/02"+str(num))
          #  sleep(60)
    # getContent("data/after/0201")
    getContent("data/after/0412")
    getContent("data/after/0413")
    print("Finished")
